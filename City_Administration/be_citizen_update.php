    ...
    <body>
            ...
            <!-- === BEGIN CONTENT === -->
                    ...
                    <div class=" margin-vert-30">
                       ...
                       <div class="col-md-12">
                         <div class="col-md-6">
                           <font size="7">Backend : Users</font>
                           </div>
                            <div class="col-md-6">
...
//	echo $var_value;
	$query1  = "SELECT * FROM citizen WHERE id=$nr";
	$qqq1=mysqli_query($con,$query1) or  die("Error, query failed2");
	$row1 = mysqli_fetch_array($qqq1)

?>
	 <div class="row">
 	 <form action="be_citizen_1.php" method="POST" enctype="multipart/form-data">
             <div class="col-sm-2 col-xs-2">
                                <input name="aadhar" class="form-control margin-bottom-20" type="text" value="<?php echo $row1['aadhar']; ?>">
             </div>
          <div class="col-sm-2 col-xs-2">
             ...
             <div class="col-sm-2 col-xs-2">
               ...
               <div class="col-sm-1 col-xs-1">
                                <textarea name="address" type="text" class="form-control margin-bottom-20"> <?php echo $row1['address']; ?>
                                </textarea>
             </div>
 
              <div class="col-sm-2 col-xs-2">			 
               				 <?php echo '<img src="data:image/*;base64,'.base64_encode( $row1['profilepic'] ).'" style="border-radius:20px;" height="150px" width="150px"/>'  ?>
					  <br><br>
					</div> 
             <div class="col-sm-1 col-xs-1">
