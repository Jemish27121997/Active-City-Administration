...
<html lang="en">
 <head>
        <!-- Title -->
        <title>Backend_Public Utility</title>
        <!-- Meta -->
       <!-- Favicon -->
    ...
    <body>
            ...
            <!-- === BEGIN CONTENT === -->
                    ...
                    <div class=" margin-vert-30">
                       ...
                       <div class="col-md-12">
                         <div class="col-md-6">
                           <font size="7">Backend : Public utility</font>
                           </div>
                            <div class="col-md-6">
                          <p class="text-right"> <font size="6"> 
                           <a href="admin.php"><span type="span" class="label label-warning">Home</span></a>
                           <a href="be_publicutility_insert.php"><span type="span" class="label label-warning">insert</span></a></font></p>
                            </div>
                            <br>
                             <br> <br>
                        <div class="col-md-12">
...
//	echo $var_value;
	$query1  = "SELECT * FROM utility WHERE id=$nr";
	$qqq1=mysqli_query($con,$query1) or  die("Error, query failed2");
	$row1 = mysqli_fetch_array($qqq1)

?>
	 <div class="row">
 	 <form action="be_publicutility_1.php" method="POST">
             <div class="col-sm-1 col-xs-1">
                                <input name="id" class="form-control margin-bottom-20" type="text" value="<?php echo $row1['id']; ?>">
             </div>
          <div class="col-sm-2 col-xs-2">
                                <input name="type" class="form-control margin-bottom-20" type="text" value="<?php echo $row1['type']; ?>" >
             </div>
               <div class="col-sm-3 col-xs-3">
