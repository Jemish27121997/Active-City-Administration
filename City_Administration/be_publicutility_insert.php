 ...
 <head>
    ...
    <body>
            ...
            <!-- === BEGIN CONTENT === -->
                    ...
                    <div class=" margin-vert-30">
                        ...
                        <div class="col-md-12">
                       <font size="7">Backend : Public utility</font><br><br><br>
   ...
   <?php
 	...
 	<form action="be_publicutility_1.php" method="POST">
          ...
          <div class="col-sm-2 col-xs-2">
                                <input name="type" class="form-control margin-bottom-20" type="text"  >
             </div>
               <div class="col-sm-3 col-xs-3">
                                <input name="name" class="form-control margin-bottom-20" type="text"  >
             </div>
               <div class="col-sm-3 col-xs-3">
                                <textarea name="address" type="text" class="form-control margin-bottom-20">
                                </textarea>
             </div>
               <div class="col-sm-2 col-xs-2">
        				...
        				<div class="col-md-12">
                          <p class="text-center"> <font size="6">
                           <a href="admin.php"><span type="span" class="label label-warning">Home</span></a>
                            <a href="be_publicutility_update.php"><span type="span" class="label label-warning">back</span></a></font></p>
                            </div>
    </body>
</html>
