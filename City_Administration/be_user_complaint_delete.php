...
<html lang="en">
 <head>
    ...
    <body>
            ...
            <!-- === BEGIN CONTENT === -->
                    ...
                    <div class=" margin-vert-30">
                        ...
                        <div class="col-md-12">
                        <font size="7">Backend : Complaint</font><br><br><br>
                       <div class="row text-center"><font size="5">Delete</font></div>
                              <br><br>
   ...
   <?php
	 ...
	 <div class="row">
 	<form action="be_user_complaint_1.php" method="POST" >
        			...
        			<br><br>
        				<div class="col-md-12">
                          <p class="text-center"> <font size="6"> 
                           ...
                           <a href="be_user_complaint_update.php"><span type="span" class="label label-warning">back</span></a></font></p>
                            </div>
    </body>
</html>
